<template>
    <v-app>
        <v-container class="pa-3" v-show="edit_addr=== false">
            <div v-show ="DetailEdit_error === true">
        ...
        <v-container v-show="edit_addr === true"> 
            <DetailAddress @Address="ResultAddress"></DetailAddress>
        </v-container>
    </v-app>
...
import DetailAddress from '../DetailComponents/DetailAddress.vue';
export default{
  components: { DetailAddress },
    data() {
...
///////////////////////////////////////////////////////////연도 선택
    ...
    computed: {
        ...mapState({productInfo:'productInfo', beforeImage: 'beforeImage', edit_addr: 'edit_addr', DetailEdit_error:'DetailEdit_error'})
    },
    created(){
    }
}
